...
<head>
  <meta charset="UTF-8">
  <title>Beyond: Two Souls – GamesWeb</title>
...
<div class="game-hero">
  <img class="hero-img" src="zdj/b2s/MainB.jpg" alt="Beyond: Two Souls">
    ...
    <div class="cast-section">
      ...
      <div class="cast-grid">
        <?php foreach ($cast as $c):
          ...
          $imgFile = file_exists('zdj/b2s/' . $base . '.webp') ? $base . '.webp' : $base . '.jpg';
          $born = $c['birth_date'] ? date('Y', strtotime($c['birth_date'])) : '—';
        ?>
        <div class="cast-card">
          <img src="zdj/b2s/<?= $imgFile ?>" alt="<?= htmlspecialchars($c['first_name'] . ' ' . $c['last_name']) ?>">
          <div class="cast-info">
