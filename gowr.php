...
<head>
  <meta charset="UTF-8">
  <title>God of War: Ragnarok – GamesWeb</title>
...
<div class="game-hero">
  <img class="hero-img" src="zdj/GoWR/MainG.jpg" alt="God of War: Ragnarok">
    ...
    <div class="cast-section">
      ...
      <div class="cast-grid">
        <?php foreach ($cast as $c):
          ...
          $imgFile = file_exists('zdj/GoWR/' . $base . '.webp') ? $base . '.webp' : $base . '.jpg';
          $born = $c['birth_date'] ? date('Y', strtotime($c['birth_date'])) : '—';
        ?>
        <div class="cast-card">
          <img src="zdj/GoWR/<?= $imgFile ?>" alt="<?= htmlspecialchars($c['first_name'] . ' ' . $c['last_name']) ?>">
          <div class="cast-info">
