...
<div class="game-hero">
  <img class="hero-img" src="zdj/gtav/MainG.jpg" alt="GTA V">
    ...
    <div class="cast-section">
      ...
      <div class="cast-grid">
        <?php foreach ($cast as $c):
          ...
          $imgFile = file_exists('zdj/gtav/' . $base . '.webp') ? $base . '.webp' : $base . '.jpg';
          $born = $c['birth_date'] ? date('Y', strtotime($c['birth_date'])) : '—';
        ?>
        <div class="cast-card">
          <img src="zdj/gtav/<?= $imgFile ?>" alt="<?= htmlspecialchars($c['first_name'] . ' ' . $c['last_name']) ?>">
          <div class="cast-info">
      ...
      <?php if (isset($_SESSION['user_id'])): ?>
        ...
        <div class="comment-form">
          <form method="post">
            ...
            <textarea name="content" id="comment-editor" placeholder="Napisz komentarz..."></textarea>
